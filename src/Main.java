...
public class Main {
     ...
     *  которого зависит его урон и показатель HP. Противник с типом Goblin-Brute может разрушать блок игрока.
     *  Игрок может атаковать или блокировать. Если после хода игрока противник не был убит, то он атакует игрока.
     *  Игра продолжается, пока игрок или все враги не будут побеждены.
     */
